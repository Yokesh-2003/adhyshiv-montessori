        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-black text-blue-900 font-display">
              Premium Learning Spaces Coming Soon
            </h2>
            <p className="text-[#4a3540] font-sans text-sm sm:text-base leading-relaxed max-w-xl">
              We are currently preparing detailed walkthroughs and photographs of our environments, Montessori materials, and outdoor activity spaces. Check back soon for a comprehensive look at our campus!
            </p>
