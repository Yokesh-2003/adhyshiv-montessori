        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-black text-blue-900 font-display">
              Upcoming Celebrations & Activities
            </h2>
            <p className="text-[#4a3540] font-sans text-sm sm:text-base leading-relaxed max-w-xl">
              From our annual festivals and Montessori workshops to sports meets and student exhibitions, we will soon publish the official calendar of events and activity updates here.
            </p>
